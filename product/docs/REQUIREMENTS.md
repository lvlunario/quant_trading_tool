...
| R04 | Fidelity export importer | Reconcile balances and positions; report all rejected rows; no silent omission | PARTIAL: synthetic broker-shaped mapping and normalized reconciliation; Fidelity adapter/export validation pending |
